# Archived mixed-version results document

Archived on 2026-09-13. This file preserves the pre-cleanup document, including
historical results and its original claims. It is not the current reporting
authority. Relative paths below were written relative to the repository root.
