# Archived mixed-version Stage 3 details

Archived on 2026-09-13. Historical graph-ranking, gated temperature and serial
controls below do not define the maintained mainline. Original text is retained
for traceability; consult stage3_XGBoost/stage3_XGBoost_detail.md for current use.
...
> `stage2_ReaFNN/stage2_ReaFNN_detail.md`. Earlier serial Stage 2/3 figures and
